...
let handleUserJoined = async (user, mediaType) => {
    ...
    // Show join request if a new user joins
    document.getElementById('request-message').innerText = `${user.uid} wants to join the chat.`;
    document.getElementById('join-requests').style.display = 'block';

    document.getElementById('allow-btn').onclick = async () => {
        alert(`${user.uid} has been allowed to join.`);
        document.getElementById('join-requests').style.display = 'none';
        // Optionally, you can use client.publish here if necessary
    };

    document.getElementById('deny-btn').onclick = () => {
        alert(`${user.uid} has been denied access.`);
        document.getElementById('join-requests').style.display = 'none';
        // Optionally, you can use client.unpublish here if necessary
    };
}
